...
// Changes: Added GetBackendUrlsInOrder(), GetServerCheckUrl(),
// GetBackendUrlForAuth(), GetBackendUrlForSocketIO() to route
// requests to a configurable backend instead of backend.beammp.com.
...
public:
    ...
    static std::vector<std::string> GetBackendUrlsInOrder() {
        return {
            Settings.getAsString(Settings::Key::General_BackendUrl),
        };
    }

    static std::string GetServerCheckUrl() { return Settings.getAsString(Settings::Key::General_BackendUrl); }

    static std::string GetBackendUrlForAuth() { return Settings.getAsString(Settings::Key::General_BackendUrl); }
    static std::string GetBackendUrlForSocketIO() { return Settings.getAsString(Settings::Key::General_BackendUrl); }
